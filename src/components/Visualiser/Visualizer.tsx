    ...
    if (frequencyBandArray.length > 0) {
      ...
      if (domElements.length > 0) {
        for (let i = 0; i < frequencyBandArray.length; i++) {
          ...
          if (domElements[num]) {
            domElements[num].style.backgroundColor =
              `rgb(${color.r}, ${color.g}, ${color.b})`
            domElements[num].style.height =
              `${amplitudeValues.current?.[num]}px`
          }
        }
        if (activeFb > -1) {
                ...
                ledData &&
                  ...
                  window.api.udp([
                    ...
                    flipped
                      ...
                      : [...ledDataPrefix, ...ledData.flat()].splice(
                          s.seg[0] * 3,
                          s.seg[1] * 3
                        )
                  ])
          ...
          for (let i = 0; i < frequencyBandArray.length; i++) {
            ...
            ctx.fillRect(
              ...
              amplitudeValues.current?.[num]
                ? -amplitudeValues.current?.[num] / 20
                : 1
            )
          }
        }
    ...
    <div>
      ...
      <Box
        sx={{
          ...
          right: 0,
          paddingLeft: '16px',
          background: `linear-gradient(to top, #000c, #000c ${volume}%, transparent ${
            volume + 1
          }%)`
        }}
      />
      ...
      <div
        className={`${classes.fC} ${
          activeFb > -1 || activeRightFb > -1 ? 'selection-active' : ''
        }`}
      >
