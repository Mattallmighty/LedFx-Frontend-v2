...
const SpotifyLoginRedirect = () => {
  ...
  finishAuth()
  refreshAuth()
  setTimeout(() => window.location.href = `${process.env.NODE_ENV === 'production' ? storedURL || baseURL : 'http://localhost:3000' }/#/Integrations?`, 2000 ); // Redirect to homepage after 3 sec
  return (
